...
class FriendsListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.rightBarButtonItem = UIBarButtonItem.init(image: #imageLiteral(resourceName: "contacts_add_friend"), style: .done, target: self, action: #selector(rightBarButtonItemAction))
    }
    ...
    // rightBarButtonItem监听事件方法
    @objc private func rightBarButtonItemAction() {
        let addFriendsVC = AddFriendsViewController.init(style: .grouped)
